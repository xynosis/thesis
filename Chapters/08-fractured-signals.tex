\chapter{\textit{fractured signals}: mitigating, resisting, and constructing alternatives to capitalist realism through speculative praxis}
\label{ch:8}
